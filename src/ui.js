...
export function mainMenu(root, props) {
...
export function connecting(root, props) {
	mount(root, [
...
export function connectFailed(root, props) {
	mount(root, [
...
export function joinGame(root, props) {
	const list = el('ul');
...
export function waitingRoom(root, props) {
...
export function roomError(root, props) {
	mount(root, [
...
export function handoffDesktop(root, props) {
...
export function testSpeakers(root, props) {
	mount(root, [
...
export function settings(root, props) {
	let cleanup = null;
	...
	if (showVoiceControls) {
		...
		cleanup = props.subscribeVoicesChanged?.((newVoices) => populateVoices(newVoices));
	}
